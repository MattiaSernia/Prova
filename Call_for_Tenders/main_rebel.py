...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Rebel.log", encoding='utf-8'),
...
from custom_rebel import Custom_Graph
...
if __name__ == "__main__":
    ...
    graph=Custom_Graph("Rebel",agent_list)
    graph.triplet_extraction("Rebel.log")
...
class RequirementJudge:
    ...
    def __init__(self, model, temperature, graph):
        ...
        self.context = (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "For each requirement, ask: does the proposal EXPLICITLY talk about the SAME TOPIC?\n"
            ...
            "Skipped requirements are simply absent from the output.\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "STEP 2 — SATISFACTION JUDGEMENT (only for relevant requirements)\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "For the requirements that passed Step 1:\n"
            ...
            "CRITICAL RULES:\n"
            "- A requirement can only be SATISFIES or DOES_NOT_SATISFY if the proposal\n"
            "  EXPLICITLY mentions the topic. Do NOT infer capability from technology names.\n"
            "  Example: 'uses microservices' does NOT satisfy 'integrate with EDM'\n"
            "  unless the proposal explicitly mentions EDM integration.\n"
            "- Do NOT assume that a technology or approach COULD satisfy a requirement.\n"
            ...
            "SATISFIES:\n\n"
            "DOES_NOT_SATISFY:\n\n"
            "(Note: even if microservices could theoretically integrate with other systems,\n"
            "the proposal does not explicitly mention any integration — so all integration\n"
            "requirements are correctly skipped.)\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
